...
Im ersten Schritt werden die Daten und die Konfiguration geladen. Danach werden konfigurierte Dokumentfunktionen im __"Processing"-Schritt entsprechend aufgerufen. 
...
![x]({{ site.baseurl }}/assets/content-images/concepts/de/docengine-inheritance "Document-Engine - Vererbungssystem")
