...
{% include alert.html type="info" text="In der Standard-Installation wird eine Webseite erzeugt, welche auf den Port 80 lauscht. Dies könnt mit evtl. anderen Webseiten zu konflikten führen. <b>In dem Fall wird die OneOffixx Website nicht gestartet.</b>" %}
