...
* <span class="label label-danger">Fixed</span> Eventuell Fix und Logging code für verschwindende OrgPermissions
* <span class="label label-danger">Fixed</span> In V3 gab es das Problem, dass nicht freigebene Styles & Formatvorlagen für normale User nicht synchronisiert wurden - dies konnte zu recht heftigen Fehlern führen. Neu werden Styles / Formatvorlagen und SubDocuments immer synchronisiert.
...
* <span class="label label-danger">Fixed</span> In selten Fällen, wurde auf gewissen Computern der Ribbon in einem neuen Mail wenn man offline war nicht angezeigt.
...
* <span class="label label-success">New</span> Zuletzt geklicktes Template wird nun (in Memory) pro TemplateGroup gemerkt.
...
Die Version 3.1 wurde offiziell veröffentlicht und beinhaltet folgende Hauptfeatures:
...
In dieser Version wurde das Ladeverhalten der AddIns optimiert. Outlook dürfte nicht mehr versuchen das AddIn wegen langsamen Startens zu deaktivieren.
...
# OneOffixx 2.3.50060
Branch von Release 2.3.4 - Es wurde ein Fehler beim "komplett Überschreiben" von Snippets gefunden, der dazu führte, dass Textbausteine verloren gehen (nur in mehrsprachigen Umgebungen). Die Funktionalität wurde angepasst, sodass kein Snippet mehr gelöscht wird. Neu wird der Content der entsprechenden Sprachen einfach überschrieben.
...
* <span class="label label-danger">Fixed</span> ClientVersion wird nun in jedem Request mitgeliefert.
* <span class="label label-danger">Fixed</span> <span class="label label-warning">Urgent</span> Es wurde ein Fehler entdeckt, der dazu führen konnte, dass eventuell mehrere Textbaustein-Favoriten erstellt wurden, welche auf denselben Textbaustein zeigen. Dies führte dazu, dass der gesamte Textbaustein-Katalog im Client nicht mehr erstellt werden konnte. Neue Textbausteinfavoriten können nun nur noch mit v2.3.5 bzw. v3 erstellt werden!
...
* <span class="label label-danger">Fixed</span> Profil-Management: Wenn man alle Profile bis auf eins gelöscht hatte, gab es den Fall, dass es so aussah, als hätte man zwei "Standard-Email" Profile. Der Fehler wurden behoben.
...
* <span class="label label-danger">Fixed</span> Das Unterschriftsprofil für einen anderen Benutzer hinzuzufügen, konnte abstürzen, falls ein freigegebenes Profil keine OE hat.
...
* <span class="label label-danger">Fixed</span> UserMigrator zeigt nun eine Warnung an, falls mehrere User ein Matching-Kriterium erfüllen - vorher ist es komplett abgestürzt.
* <span class="label label-success">New</span> SyncFusion PDF Update - ist nun gleich mit der "OneOffixx"/V3 Branch.
...
* <span class="label label-success">New</span> Beim Importieren von Templates werden GlobalFunctionen jetzt standardmässig nicht mitimportiert.
...
* <span class="label label-danger">Fixed</span> DocFunc Recipient:Clipboard-Adressen werden nun wieder geparst und sie sind editierbar.
...
* <span class="label label-success">New</span> MetaData DF ist nun serverseitig erreichbar.
...
* <span class="label label-danger">Fixed</span> Bislang hat Outlook versehentlich den TaskPanel Host von Powerpoint mit genutzt, da diese die gleiche ID hatten. Das ist nun korrigiert und Powerpoint hat nun eine eigene ID.
* <span class="label label-danger">Fixed</span> Unsichtbares Zeichen in Mailsignature entfernen - es wird nun ein Feld eingefügt.
...
* <span class="label label-danger">Fixed</span> Gewähltes Profil/Sprache wird nun nicht mehr über Outlook UserProperties gelöst, sondern über den Mailheader. Fixt das "signierte-Email" Problem.
...
* <span class="label label-success">New</span> Abacus Adressprovider unterstützt neu einen gemeinsamen Service User. Dieser benötigt in der globalen Konfiguration zusätzlich die Parametern <User/>,<Password/> und <Mandant/>. _Es wird dringend empfohlen, die Abacus-Schnittstelle mit dem GenericAdressProvider umzusetzen, da die Suche wesentlich besser ist._
