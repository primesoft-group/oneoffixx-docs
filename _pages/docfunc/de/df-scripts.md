...
Bsp.                | `<Link id="Profile.User.URL" text="Web"/>` <br/> `   y<Link id="Profile.Org.Web" bindingText="Profile.Org.Web" style="color:green;font:italic" />` <br/> `<Link imageURL="test-Dateien/tel-symbol.png" height="10">www.oneoffixx.com</Link>`
