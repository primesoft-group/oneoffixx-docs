...
Bsp. mehrzeilig     | `<Line>` <br/> `<Link id="Profile.Org.Web" bindingText="Profile.Org.Web" />` <br/> `<Text>&#160;</Text>` <br/> `</Line>` <br/> `<Line>` <br/> `<Link id="Profile.Org.Email" type="mailto" bindingText="Profile.Org.Email" />` <br/> `<Text>&#160;</Text>` <br/> `</Line>` :collision: 