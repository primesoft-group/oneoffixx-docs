...
## AbacusGenericSQL
Der [Generic SQL Provider]({{ site.baseurl }}docfunc/de/df/ap/gernericsql) versucht aufgrund des Vornamens zu erkennen ob es sich um eine private oder geschäftliche Adresse handelt.
