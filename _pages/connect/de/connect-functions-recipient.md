          ...
          <ContactList>
            ...
            <ContactItem Selected="true" id="123456789">
              <!-- Adressart
                   ...
                   Achtung: um festzulegen, ob die private oder die geschäftliche Adresse verwendet wird, muss SelectedAddress von ContactViewOptions verwendet werden -->
              ...
              <ContactViewOptions 
                ...
                AddressingType="An"
                ShowProviderLayout="false"
                PersonOverFirm="true"
                CountryView="true"
                CountryCodeView="true"
                SalutationView="true"
                SalutationSeparatetLine="false"
                SecondNameView="false"
                PositionView="true" />
            </ContactItem>
          </ContactList>
        </Arguments>
